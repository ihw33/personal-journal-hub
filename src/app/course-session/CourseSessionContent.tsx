...
export default function CourseSessionContent() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-architect-gray-100/30 via-white to-architect-primary/5">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-body text-architect-gray-700">인증을 확인하고 있습니다...</p>
        </div>
      </div>
    );
  }
  ...
  const handleNavigate = (page: string, params?: any) => {
    ...
    switch (page) {
      case 'course-dashboard':
        ...
        break;
      case 'course-detail':
        router.push(`/courses/${params?.courseId || validatedParams.courseId}`);
        break;
      case 'dashboard':
