    ...
    ko: {
      ...
      sections: {
        ...
        support: {
          ...
          links: [
            { name: '도움말', page: 'help' },
            { name: '문의하기', page: 'coming-soon' },
            { name: '커뮤니티', page: 'coming-soon' }
          ]
        },
        legal: {
          title: '법적 고지',
        ...
        company: {
          title: '회사',
          links: [
            { name: '사이트맵', page: 'sitemap' },
            { name: '버전 히스토리', page: 'version-history' }
          ]
        }
      },
      newsletter: {
      ...
      sections: {
        platform: {
          ...
          links: [
            ...
            { name: 'AI Practice', page: 'ai-practice' }
          ]
        },
        support: {
          title: 'Support',
          links: [
            { name: 'Help', page: 'help' },
            { name: 'Contact', page: 'coming-soon' },
            { name: 'Community', page: 'coming-soon' }
          ]
        },
        legal: {
          title: 'Legal',
        ...
        company: {
          ...
          links: [
            ...
            { name: 'Version History', page: 'version-history' }
          ]
        }
      },
      newsletter: {
