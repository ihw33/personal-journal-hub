...
export function JejuCourseOverview({ user, language, onNavigate }: JejuCourseOverviewProps) {
                  ...
                  <Button 
                    onClick={() => {
                      if (!user) {
                        ...
                        onNavigate('weekly-learning', undefined, undefined, 1);
                      }
                    }}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid gap-6">
              {JEJU_COURSE_DATA.map((week, index) => (
                <Card key={week.id} className={`${getWeekTypeColor('guide-start')} border-2`}>
                  <CardContent className="p-6">
                      ...
                      <Button 
                        ...
                        onClick={() => {
                          if (!user) {
                            ...
                            onNavigate('weekly-learning', undefined, undefined, week.id);
                          }
                        }}
                      >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {week.objectives.slice(0, 3).map((objective, topicIndex) => (
